...
import { Condicion7Service } from '../../../services/condicion7/condicion7.service';

@Component({
  selector: 'app-condicion7edit',
  templateUrl: './condicion7edit.component.html',
  styleUrls: ['./condicion7edit.component.css'],
  providers: [DatePipe, NgbProgressbarConfig],
})
export class Condicion7editComponent implements OnInit {
today = new Date();
  fecha: any;
  closeResult: string;
  defaultImgUrl: any;
  ...
  constructor(
    ...
    private condicion7Services: Condicion7Service,
    ...
    this.activatedRoute.params.subscribe((parametros) => {
      ...
      if (this.id !== 'nuevo') {
        this.condicion7Services.getCondicion7(this.id).subscribe(
          (condicion7) => (this.condicion7 = condicion7)
        );
      }
    });
  }
  ...
  ngOnInit() {
    this.headerTitleService.setTitle('7 PROFESORES');
    this.war = this.condicion7.aspecto1Programa;
  ...
  guardar() {
    if (
      this.condicion7.aspecto1Programa !== this.war ||
      this.condicion7.aspecto1Programa !== this.war
    ) {
      this.error = false;
      console.log(this.condicion7.aspecto1Programa);
      console.log(this.war);
      this.modalReference.close();
      if (this.id === 'nuevo') {
        this.condicion7Services.nuevoCondicion7(this.condicion7).subscribe(
          (data) => {
            this.showSuccess();
        ...
        this.modalReference.close();
        this.condicion7Services.actualizarCondicion7(
          this.condicion7,
          this.id
        ).subscribe(
          (data) => {
  ...
  subirArchivoAspecto1() {
    this.condicion7.aspecto1File = this.nombreArchivo1;
    this.nombreArchivo1 = 'condicion7/SOPORTES/' + this.nombreArchivo1;
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion7.aspecto1File = this.URLPublica1;
            return [
              this.URLPublica1,
              this.finalizado1,
              this.condicion7.aspecto1File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto2() {
    this.condicion7.aspecto2File = this.nombreArchivo2;
    this.nombreArchivo2 = 'condicion7/SOPORTES/' + this.nombreArchivo2;
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion7.aspecto2File = this.URLPublica2;
            return [
              this.URLPublica2,
              this.finalizado2,
              this.condicion7.aspecto2File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto3() {
    this.condicion7.aspecto3File = this.nombreArchivo3;
    this.nombreArchivo3 = 'condicion7/SOPORTES/' + this.nombreArchivo3;
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion7.aspecto3File = this.URLPublica3;
            return [
              this.URLPublica3,
              this.finalizado3,
              this.condicion7.aspecto3File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto4() {
    this.condicion7.aspecto4File = this.nombreArchivo4;
    this.nombreArchivo4 = 'condicion7/SOPORTES/' + this.nombreArchivo4;
      ...
      if (this.porcentaje4 === 100) {
        setTimeout(() => {
          referencia4.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion7.aspecto4File = this.URLPublica4;
            return [
              this.URLPublica4,
              this.finalizado4,
              this.condicion7.aspecto4File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto5() {
    this.condicion7.aspecto5File = this.nombreArchivo5;
    this.nombreArchivo5 = 'condicion7/SOPORTES/' + this.nombreArchivo5;
      ...
      if (this.porcentaje5 === 100) {
        setTimeout(() => {
          referencia5.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion7.aspecto5File = this.URLPublica5;
            return [
              this.URLPublica5,
              this.finalizado5,
              this.condicion7.aspecto5File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto6() {
    this.condicion7.aspecto6File = this.nombreArchivo6;
    this.nombreArchivo6 = 'condicion7/SOPORTES/' + this.nombreArchivo6;
      ...
      if (this.porcentaje6 === 100) {
        setTimeout(() => {
          referencia6.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion7.aspecto6File = this.URLPublica6;
            return [
              this.URLPublica6,
              this.finalizado6,
              this.condicion7.aspecto6File,
            ];
          });
        }, 2000);
      }
