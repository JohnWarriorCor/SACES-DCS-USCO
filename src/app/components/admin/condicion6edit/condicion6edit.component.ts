...
import { Condicion6Service } from '../../../services/condicion6/condicion6.service';

@Component({
  selector: 'app-condicion6edit',
  templateUrl: './condicion6edit.component.html',
  styleUrls: ['./condicion6edit.component.css'],
  providers: [DatePipe, NgbProgressbarConfig],
})
export class Condicion6editComponent implements OnInit {
  today = new Date();
  fecha: any;
  closeResult: string;
  defaultImgUrl: any;
  ...
  constructor(
    ...
    private condicion6Services: Condicion6Service,
    ...
    this.activatedRoute.params.subscribe((parametros) => {
      ...
      if (this.id !== 'nuevo') {
        this.condicion6Services.getCondicion6(this.id).subscribe(
          (condicion6) => (this.condicion6 = condicion6)
        );
      }
    });
  }
  ...
  ngOnInit() {
    this.headerTitleService.setTitle('6 RELACIÓN CON EL SECTOR EXTERNO');
    this.war = this.condicion6.aspecto1Programa;
  ...
  guardar() {
    if (
      this.condicion6.aspecto1Programa !== this.war ||
      this.condicion6.aspecto1Programa !== this.war
    ) {
      this.error = false;
      console.log(this.condicion6.aspecto1Programa);
      console.log(this.war);
      this.modalReference.close();
      if (this.id === 'nuevo') {
        this.condicion6Services.nuevoCondicion6(this.condicion6).subscribe(
          (data) => {
            this.showSuccess();
        ...
        this.modalReference.close();
        this.condicion6Services.actualizarCondicion6(
          this.condicion6,
          this.id
        ).subscribe(
          (data) => {
  ...
  subirArchivoAspecto1() {
    this.condicion6.aspecto1File = this.nombreArchivo1;
    this.nombreArchivo1 = 'condicion6/SOPORTES/' + this.nombreArchivo1;
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion6.aspecto1File = this.URLPublica1;
            return [
              this.URLPublica1,
              this.finalizado1,
              this.condicion6.aspecto1File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto2() {
    this.condicion6.aspecto2File = this.nombreArchivo2;
    this.nombreArchivo2 = 'condicion6/SOPORTES/' + this.nombreArchivo2;
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion6.aspecto2File = this.URLPublica2;
            return [
              this.URLPublica2,
              this.finalizado2,
              this.condicion6.aspecto2File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto3() {
    this.condicion6.aspecto3File = this.nombreArchivo3;
    this.nombreArchivo3 = 'condicion6/SOPORTES/' + this.nombreArchivo3;
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion6.aspecto3File = this.URLPublica3;
            return [
              this.URLPublica3,
              this.finalizado3,
              this.condicion6.aspecto3File,
            ];
          });
        }, 2000);
      }
