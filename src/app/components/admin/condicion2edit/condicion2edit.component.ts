...
import { Condicion2Service } from '../../../services/condicion2/condicion2.service';

@Component({
  selector: 'app-condicion2edit',
  templateUrl: './condicion2edit.component.html',
  styleUrls: ['./condicion2edit.component.css'],
  providers: [DatePipe, NgbProgressbarConfig],
})
export class Condicion2editComponent implements OnInit {
  today = new Date();
  fecha: any;
  closeResult: string;
  defaultImgUrl: any;
  ...
  constructor(
    ...
    private condicion2Services: Condicion2Service,
    ...
    this.activatedRoute.params.subscribe((parametros) => {
      ...
      if (this.id !== 'nuevo') {
        this.condicion2Services
          .getCondicion2(this.id)
          .subscribe((condicion2) => (this.condicion2 = condicion2));
      }
    });
  }
  showSuccess() {
  ...
  ngOnInit() {
    this.headerTitleService.setTitle('2 JUSTIFICACIÓN DEL PROGRAMA');
    this.war = this.condicion2.aspecto1Programa;
  ...
  guardar() {
    if (
      this.condicion2.aspecto1Programa !== this.war ||
      this.condicion2.aspecto1Programa !== this.war
    ) {
      this.error = false;
      console.log(this.condicion2.aspecto1Programa);
      console.log(this.war);
      this.modalReference.close();
      if (this.id === 'nuevo') {
        this.condicion2Services.nuevoCondicion2(this.condicion2).subscribe(
          (data) => {
            this.showSuccess();
        ...
        this.modalReference.close();
        this.condicion2Services
          .actualizarCondicion2(this.condicion2, this.id)
          .subscribe(
            (data) => {
              this.showInfo();
              this.router.navigate(['/agenda']);
  ...
  subirArchivoAspecto1() {
    this.condicion2.aspecto1File = this.nombreArchivo1;
    this.nombreArchivo1 = 'CONDICION2/SOPORTES/' + this.nombreArchivo1;
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion2.aspecto1File = this.URLPublica1;
            return [
              this.URLPublica1,
              this.finalizado1,
              this.condicion2.aspecto1File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto2() {
    this.condicion2.aspecto2File = this.nombreArchivo2;
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion2.aspecto2File = this.URLPublica2;
            return [
              this.URLPublica2,
              this.finalizado2,
              this.condicion2.aspecto2File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto3() {
    this.condicion2.aspecto3File = this.nombreArchivo3;
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion2.aspecto3File = this.URLPublica3;
            return [
              this.URLPublica3,
              this.finalizado3,
              this.condicion2.aspecto3File,
            ];
          });
        }, 2000);
      }
