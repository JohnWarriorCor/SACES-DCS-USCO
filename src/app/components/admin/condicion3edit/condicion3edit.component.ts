...
import { Condicion3Service } from '../../../services/condicion3/condicion3.service';

@Component({
  selector: 'app-condicion3edit',
  templateUrl: './condicion3edit.component.html',
  styleUrls: ['./condicion3edit.component.css'],
  providers: [DatePipe, NgbProgressbarConfig],
})
export class Condicion3editComponent implements OnInit {
  today = new Date();
  fecha: any;
  closeResult: string;
  defaultImgUrl: any;
  ...
  // VARIABLES CARGA DE ARCHIVO A FIRESTORE ASPECTO 7
  ...
  constructor(
    ...
    private Condicion3Services: Condicion3Service,
    ...
    this.activatedRoute.params.subscribe((parametros) => {
      ...
      if (this.id !== 'nuevo') {
        this.Condicion3Services.getCondicion3(this.id).subscribe(
          (condicion3) => (this.condicion3 = condicion3)
        );
      }
    });
  }
  ...
  ngOnInit() {
    this.headerTitleService.setTitle('3 ASPECTOS CURRICULARES');
    this.war = this.condicion3.aspecto1Programa;
  ...
  guardar() {
    if (
      this.condicion3.aspecto1Programa !== this.war ||
      this.condicion3.aspecto1Programa !== this.war
    ) {
      this.error = false;
      console.log(this.condicion3.aspecto1Programa);
      console.log(this.war);
      this.modalReference.close();
      if (this.id === 'nuevo') {
        this.Condicion3Services.nuevoCondicion3(this.condicion3).subscribe(
          (data) => {
            this.showSuccess();
        ...
        this.modalReference.close();
        this.Condicion3Services.actualizarCondicion3(
          this.condicion3,
          this.id
        ).subscribe(
          (data) => {
  ...
  subirArchivoAspecto1() {
    this.condicion3.aspecto1File = this.nombreArchivo1;
    this.nombreArchivo1 = 'condicion3/SOPORTES/' + this.nombreArchivo1;
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto1File = this.URLPublica1;
            return [
              this.URLPublica1,
              this.finalizado1,
              this.condicion3.aspecto1File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto2() {
    this.condicion3.aspecto2File = this.nombreArchivo2;
    this.nombreArchivo2 = 'CONDICION3/SOPORTES/' + this.nombreArchivo2;
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto2File = this.URLPublica2;
            return [
              this.URLPublica2,
              this.finalizado2,
              this.condicion3.aspecto2File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto3() {
    this.condicion3.aspecto3File = this.nombreArchivo3;
    this.nombreArchivo3 = 'CONDICION3/SOPORTES/' + this.nombreArchivo3;
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto3File = this.URLPublica3;
            return [
              this.URLPublica3,
              this.finalizado3,
              this.condicion3.aspecto3File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto4() {
    this.condicion3.aspecto4File = this.nombreArchivo4;
    this.nombreArchivo4 = 'CONDICION3/SOPORTES/' + this.nombreArchivo4;
      ...
      if (this.porcentaje4 === 100) {
        setTimeout(() => {
          referencia4.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto4File = this.URLPublica4;
            return [
              this.URLPublica4,
              this.finalizado4,
              this.condicion3.aspecto4File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto5() {
    this.condicion3.aspecto5File = this.nombreArchivo5;
    this.nombreArchivo5 = 'CONDICION3/SOPORTES/' + this.nombreArchivo5;
      ...
      if (this.porcentaje5 === 100) {
        setTimeout(() => {
          referencia5.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto5File = this.URLPublica5;
            return [
              this.URLPublica5,
              this.finalizado5,
              this.condicion3.aspecto5File,
            ];
          });
        }, 2000);
      }
  ...
  subirArchivoAspecto6() {
    this.condicion3.aspecto6File = this.nombreArchivo6;
    this.nombreArchivo6 = 'CONDICION3/SOPORTES/' + this.nombreArchivo6;
      ...
      if (this.porcentaje6 === 100) {
        setTimeout(() => {
          referencia6.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto6File = this.URLPublica6;
            return [
              this.URLPublica6,
              this.finalizado6,
              this.condicion3.aspecto6File,
            ];
          });
        }, 2000);
      }
  ...
  // ASPECTO 7
  // Evento que se gatilla cuando el input de tipo archivo cambia
  public cambioArchivoAspecto7(event) {
    if (event.target.files.length > 0) {
      // tslint:disable-next-line:prefer-for-of
      for (let i = 0; i < event.target.files.length; i++) {
  ...
  // Sube el archivo a Cloud Storage URL NORMA PROGRAMA
  subirArchivoAspecto7() {
    this.condicion3.aspecto7File = this.nombreArchivo7;
    this.nombreArchivo7 = 'CONDICION3/SOPORTES/' + this.nombreArchivo7;
      ...
      if (this.porcentaje7 === 100) {
        setTimeout(() => {
          referencia7.getDownloadURL().subscribe((URL) => {
            ...
            this.condicion3.aspecto7File = this.URLPublica7;
            return [
              this.URLPublica7,
              this.finalizado7,
              this.condicion3.aspecto7File,
            ];
          });
        }, 2000);
      }
